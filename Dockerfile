...
RUN apt-get install -y git curl zip nfs-common sudo ca-certificates ccache cmake python-dev libffi-dev libyaml-dev python-setuptools && rm -rf /var/lib/apt/lists/*
